...
bool touchedSquare(short x, short y, short myX, short myY, int len, int myLength)
{
    return ((myX-myLength/2 <= x+len/2 && 
      ...
      myY+myLength/2 <= y+len/2) || //myBottomLeft touching 
     (myX+myLength/2 >= x-len/2 && 
      myX+myLength/2 <= x+len/2 && 
      myY+myLength/2 >= y-len/2 &&
      myY+myLength/2 <= y+len/2) || //myBottomRight touching 
     (myX+myLength/2 >= x-len/2 && 
      myX+myLength/2 <= x+len/2 && 
      myY-myLength/2 <= y+len/2 &&
      myY-myLength/2 >= y-len/2) || //myTopRight touching 
     (myX-myLength/2 <= x+len/2 && 
      myX-myLength/2 >= x-len/2 && 
      myY-myLength/2 <= y+len/2 &&
      myY-myLength/2 >= y-len/2));  //myTopLeft touching 
